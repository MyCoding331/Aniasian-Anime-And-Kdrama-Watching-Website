...
const TermsCondition = () => {
  return (
    ...
    <div className="terms-condition" >
      ...
      <p>Welcome to ANISIAN!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of ANISIAN's Website, located at <a href="https://ANISIAN.fun">https://ANISIAN.fun.</a>
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use ANISIAN if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing ANISIAN, you agreed to use
        cookies in agreement with the ANISIAN's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, ANISIAN and/or its licensors own the
        intellectual property rights for all material on ANISIAN. All
        intellectual property rights are reserved. You may access this from
        ANISIAN for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from ANISIAN</li>
        <li>Sell, rent or sub-license material from ANISIAN</li>
        <li>Reproduce, duplicate or copy material from ANISIAN</li>
        <li>Redistribute content from ANISIAN</li>
      </ul>
      ...
      <p>
        ...
        ANISIAN does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of ANISIAN,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, ANISIAN shall not be liable for the
      ...
      <p>
        ANISIAN reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant ANISIAN a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of ANISIAN; and (d) the link is in
      ...
      <p>
        ...
        e-mail to ANISIAN. Please include your name, your organization name,
      ...
      <p>
        No use of ANISIAN's logo or other artwork will be allowed for linking
